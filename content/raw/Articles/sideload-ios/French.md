...
2. Une semaine avant expiration : 7 jours après l’installation d’une app, celle-ci expirera et refusera de s’ouvrir (aucune donnée ne sera effacée). Pour éviter cela, vous devrez la « refresh » avant la fin de ce délai. Cette étape peut être automatisée si vous utilisez un magasin d’apps.
...
1. Soyez vigilant si votre modèle d’iPhone ou votre version d’iOS est ancienne (ex: [iOS 26.1 qui inclut une faille dans l’iTunes Store](https://x.com/blackorbird/status/1989904744236945494)).
